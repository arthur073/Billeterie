...
public class AchatDAO extends ProviderDAO<Achat> {
   ...
   public List<Achat> getListeAchatsClientRepresentation(String login,
      ...
      try {
         ...
         PreparedStatement st = conn
               .prepareStatement(getRequete("SELECT_LISTE_RESERVATIONS_CLIENT_REPRESENTATION"));
   ...
   public List<Achat> getListeAchatsClientAvecHistorique(String login)
      ...
      try {
         conn = getConnection();
         PreparedStatement st = conn
               .prepareStatement(getRequete("SELECT_LISTE_ACHATS_CLIENT_AVEC_HISTORIQUE"));
         st.setString(1, login);
         rs = st.executeQuery();
   ...
   public List<Achat> getListeAchatsClientSansHistorique(String login)
      ...
      try {
         conn = getConnection();
         PreparedStatement st = conn
               .prepareStatement(getRequete("SELECT_LISTE_ACHATS_CLIENT_SANS_HISTORIQUE"));
         st.setString(1, login);
         rs = st.executeQuery();
   ...
   public void setAchatClient(Achat a) throws DAOException {
      ...
      try {
         conn = getConnection();
         PreparedStatement st = conn
               .prepareStatement(getRequete("INSERT_ACHAT"));
