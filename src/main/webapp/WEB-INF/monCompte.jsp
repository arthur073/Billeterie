    ...
    <table class="indexTable">
        ...
        <c:forEach items="${listRes}" var="resa">
            <tr>
                ...
                <td>
                    <a href="UtilisateursControleur?action=achatPlaces&login=${login}&noSpectacle=${resa.noSpectacle}&noRepresentation=${resa.noRepresentation}&noZ=${resa.noZone}&noRang=${resa.noRang}&noP=${resa.noPlace}&prixTotal=${resa.tarifBase}&places=${places}resAsupprimer=1" class="btnBlack widthFixed" >Payer</a>
                    <br/><br/>
